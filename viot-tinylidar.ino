/*
  ...
  2/23/18  - VIOT - Modified code to use the TinyLidar module.
*/
...
#define light_state_topic "bruh/lidar"
#define light_set_topic "bruh/lidar/set"
...
void loop() {
  ...
  client.loop();
    ...
    int16_t newLidar = ( Wire.read()<<8 | Wire.read() ); 
    if (newLidar < 0)
      newLidar=lidarValue;
